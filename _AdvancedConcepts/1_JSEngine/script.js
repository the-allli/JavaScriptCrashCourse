...
JS-Engine
{
  ...
  // it operates on the LIFO principal
  ...
  // global variables, event listeners, setInterval()
  ...
  // Memoization => Memoization is a way to cache a return value of a function based on its parameters. This makes the function that takes a long time to run much faster after one execution. If the parameter changes, it will still have to re-evaluate the function.
  // Memoization
  // Bad Way
  function addTo80(n) {
